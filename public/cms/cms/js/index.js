            ...
            if(len>0) {
                for (var i = 0; i < len; i++) {
                    ...
                    str += '<tr>' +
                        ...
                        '<td>' + item.snap_address['name']  + item.snap_address['mobile'] + item.snap_address['province'] + item.snap_address['city'] + item.snap_address['country'] + item.snap_address['detail']  + '</td>' +
